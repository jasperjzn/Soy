...
//  SoySoy
//
//  Created by ZhunengJ on 10/25/16.
//  Copyright © 2016 ZhunengJ. All rights reserved.
//

import UIKit

class PastOrdersViewController: UIViewController, UICollectionViewDelegateFlowLayout, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        titleLabel.attributedText = NSAttributedString(string: "Past Orders", attributes: attributes)
        ...
        BackButton.addTarget(self, action: #selector(PastOrdersViewController.CancelDidTapped), for: .touchUpInside)
    ...
    {
        let screenSize: CGRect = UIScreen.main.bounds
        let tempHeight = 12+12+(PastOrders[indexPath.row].getItems().count)*34+1+68+1+136
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = OrdersCollectionView.dequeueReusableCell(withReuseIdentifier: "PastOrdersCell", for: indexPath as IndexPath) as! PastOrderCollectionViewCell
        ...
        cell.OrderItemsTableViewHeight.constant = CGFloat(PastOrders[indexPath.row].getItems().count*34)
        cell.Orders = PastOrders[indexPath.row].getItems()
        cell.OrderNames = PastOrders[indexPath.row].getItemNames()
        //-------------------------------------------------------------------------------------------------------
        let TotalAmountLabelText = NSMutableAttributedString(
            string: "US$"+PastOrders[indexPath.row].getTotalAmount(),
        ...
        //-------------------------------------------------------------------------------------------------------
        cell.LocationMarkerImage.image = UIImage(named: "cut_map_marker_151.png")
        //-------------------------------------------------------------------------------------------------------
        let LocationNameLabelText = NSMutableAttributedString(
            string: PastOrders[indexPath.row].getLocation(),
            attributes: [NSFontAttributeName:UIFont(
                name: "Avenir-Roman",
                size: 16)!])
        ...
        let LocationAddressLabelText = NSMutableAttributedString(
            string: PastOrders[indexPath.row].getAddress(),
            attributes: [NSFontAttributeName:UIFont(
                name: "Avenir-Roman",
                size: 13)!])
        ...
        //-------------------------------------------------------------------------------------------------------
        cell.ClockImage.image = UIImage(named: "cut_clock_151.png")
        //-------------------------------------------------------------------------------------------------------
        ...
        let PickUpWeekdayLabelText = NSMutableAttributedString(
            string: PastOrders[indexPath.row].getWeekday(),
            attributes: [NSFontAttributeName:UIFont(
                name: "Avenir-Roman",
                size: 13)!])
        ...
        let PickUpDayLabelText = NSMutableAttributedString(
            string: PastOrders[indexPath.row].getMonth() + " " + PastOrders[indexPath.row].getDay(),
            attributes: [NSFontAttributeName:UIFont(
                name: "Avenir-Roman",
                size: 13)!])
